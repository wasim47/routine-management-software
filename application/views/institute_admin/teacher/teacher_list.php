...
<div class="panel panel-flat">
						...
						<table class="table datatable-show-all" width="100%">
							<thead>
								<tr>
                                  <th width="2%">SI</th>
                                  <th width="28%">Teacher</th>
                                    <th width="21%">Teacher Code</th>
							...
							<tbody>
                             ...
                             <?php
									$i=0;
                                   foreach($teacher_list->result() as $teacherData):
										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li><a href="<?php echo base_url('admin/teacher_registration/'.$std_id);?>" style="color:#EDBB0E">
                                                    <i class="glyphicon glyphicon-edit"></i> Edit Information</a></li>                                                    
													<li><a href="javascript:void();" onclick="openPage1('<?php echo $std_id;?>','teacher','std_id');" style="color:#ff0000">
